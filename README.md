...
保留原生 PNG，未缩放、裁切或修正分界。横图均为 1672×941（约 16:9），竖图均为 1086×1448（3:4）。横图分界接近中点；本组竖图原图区约占 44.3–50.1%，不能据此宣称全部严格 50:50。

已检查全部大图与缩略图，并验证元数据清理。以下展示真实生成结果，**不代表全部通过风格验收**。部分等距模型偏大、场景过完整，汽车和建筑仍接近写实 CG。
