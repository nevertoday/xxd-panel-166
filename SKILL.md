---
name: xxd-panel-166
description: "Create Panel 166 raster artwork: Sculptural Isometric Bas-relief Diorama. Use when the user invokes xxd-panel-166 or requests this specific visual language."
---
...
Write final PNGs directly inside one fresh task directory under `~/Desktop/xxd/xxd-panel-166/` or the explicit output root. Use collision-safe filenames; do not create source, mode, or size subdirectories and do not generate an automatic contact sheet.
...
- `references/xxd-panel-166-prompt.zh-CN.md` and `.en.md` — delivery adapter notes
